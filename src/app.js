...
const carouselRoutes = require("./routes/web/carousel.routes");
const bannerRoutes = require("./routes/web/banner.routes");
const couponRoutes = require("./routes/web/coupon.routes");
const discountRoutes = require("./routes/web/discount.routes");
const productsRoutes = require("./routes/master/products.routes");
const sectionsRoutes = require("./routes/web/sections.routes");
const websiteDetailRoutes = require("./routes/web/websiteDetail.routes");
...
app.use("/api/v1/website-details", websiteDetailRoutes);
